...
const showContent = ()=>{
    ...
    .to(".intro-content__title--up", {
        opacity: 1
    }, "start").to(trailTextBottom.DOM.el, {
        opacity: 1
    }, "start").add(()=>{
...
// GSAP SCROLL TRIGGER  
const images = (0, _gsap.gsap).utils.toArray("li img");
...
const showDemo = ()=>{
    ...
    (0, _gsap.gsap).utils.toArray("section").forEach((section, index)=>{
...
},{"./utils":"72Dku","./trail":"bzOvk","./fakeProgress":"liM6z","./textLinesReveal":"2JTlA","./gsapAnimation":"8FhUl","gsap":"fPSuC","gsap/Flip":"iKp6p","gsap/ScrollTrigger":"7wnFk"}],"72Dku":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["cVgJb","ebWYT"], "ebWYT", "parcelRequire23b3")
