...
})({"1YYdB":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "66669d1de2a9a257";
...
},{}],"39iO6":[function(require,module,exports) {
...
frame.menu.addEventListener("click", function() {
    ...
    else menuOverlay.classList.add("active");
});
//GALERIE
// Variables
...
const updateCard = (card, idx, active)=>{
    ...
    if ((0, _flip.Flip).isFlipping(cardInner)) return;
    const cardState = (0, _flip.Flip).getState(cardInner, {
        props: "box-shadow, border-radius"
    });
    const imageState = (0, _flip.Flip).getState(image);
    ...
    (0, _gsap.gsap).killTweensOf(cardContent);
    //   gsap.to(cardContent, {
...
},{"gsap":"fPSuC","gsap/Flip":"iKp6p","gsap/ScrollTrigger":"7wnFk"}],"fPSuC":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["1YYdB","39iO6"], "39iO6", "parcelRequire23b3")

//# sourceMappingURL=galerie.e2a9a257.js.map
